...
export async function createCodeQLDatabase(repoPath: string, outputDir: string): Promise<string> {
...
export async function runCodeQLQueries(databasePath: string, outputDir: string): Promise<string> {
