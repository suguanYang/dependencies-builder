      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div>
          ...
          >
            ...
            <option value="GlobalVarRead">GlobalVarRead</option>
            <option value="GlobalVarWrite">GlobalVarWrite</option>
            <option value="WebStorageRead">WebStorageRead</option>
            <option value="WebStorageWrite">WebStorageWrite</option>
