  ...
  <div
    ...
    className={cn(
      ...
      orientation === 'responsive' &&
        '@container/field-group grid grid-cols-1 @lg:grid-cols-[1fr_auto] @lg:items-center @lg:gap-4',
...
// FieldTitle
const FieldTitle = React.forwardRef<HTMLParagraphElement, React.ComponentPropsWithoutRef<'p'>>(
  ({ className, ...props }, ref) => (
...
// FieldSeparator
const FieldSeparator = React.forwardRef<HTMLHRElement, React.ComponentPropsWithoutRef<'hr'>>(
  ({ className, ...props }, ref) => (
