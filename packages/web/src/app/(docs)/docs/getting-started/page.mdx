...
DMS（Dependency Management System）是一个全面的依赖管理系统，专门用于管理和分析微前端场景下跨多个代码仓库的项目依赖关系。该系统通过静态分析技术([CodeQL](https://codeql.github.com/docs/codeql-overview/about-codeql/))识别和跟踪代码中的各种依赖关系，帮助开发团队预防依赖破坏问题。
